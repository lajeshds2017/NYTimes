...
object FragmentUtils {
     ...
     */
    fun replaceFragment(fragmentManager: FragmentManager, fragment: Fragment, id: Int, addToBackStack: Boolean, @FragmentAnimation animationType:  Int) {
        val transaction = fragmentManager.beginTransaction()
     ...
     * @param fragment: Fragment to be added
     */
    fun openDialogFragment(activity: AppCompatActivity, fragment: DialogFragment, cancelable: Boolean = true) {
     ...
     * @param animationType: Fragment transition animation type
     */
    fun replaceFragmentAllowingStateLoss(activity: AppCompatActivity, fragment: Fragment, id: Int, addToBackStack: Boolean, @FragmentAnimation animationType: Int) {
     ...
     * @param addToBackStack: Flag indicating whether to add to backstack or not
     */
    fun replaceFragmentWithoutAnimation(activity: AppCompatActivity, fragment: Fragment, id: Int, addToBackStack: Boolean) {
        val fragmentManager = activity.supportFragmentManager
     ...
     * @param addToBackStack: Flag indicating whether to add to backstack or not
     */
    fun replaceChildFragment(currentFragment: Fragment, fragment: Fragment, id: Int, addToBackStack: Boolean) {
    ...
    fun popToFirstFragment(activity: AppCompatActivity) {
        try {
            activity.supportFragmentManager.popBackStackImmediate(activity.supportFragmentManager.getBackStackEntryAt(0).id, FragmentManager.POP_BACK_STACK_INCLUSIVE)
        } catch (e: IndexOutOfBoundsException) {
            Timber.log(Log.ASSERT, e.message)
        } catch (e: NullPointerException) {
            Timber.log(Log.ASSERT, e.message)
